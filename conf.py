# -*- coding: utf-8 -*-
#
# test documentation build configuration file.
#
...
project = 'onlinepayments-sdk-python'
copyright = 'Copyright (c) 2020 Ingenico e-Commerce Solutions B.V..'
...
htmlhelp_basename = 'onlinepayments-sdk-pythondoc'
...
latex_documents = [
    (master_doc, 'onlinepayments-sdk-python.tex', 'onlinepayments-sdk-python Documentation',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'onlinepayments-sdk-python', 'onlinepayments-sdk-python Documentation',
     [author], 1)
]
