...
project = 'onlinepayments-sdk-python3'
copyright = 'Copyright (c) 2020 Global Collect Services B.V.'
...
htmlhelp_basename = 'onlinepayments-sdk-python3doc'
...
latex_documents = [
    (master_doc, 'onlinepayments-sdk-python3.tex', 'onlinepayments-sdk-python3 Documentation',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'onlinepayments-sdk-python3', 'onlinepayments-sdk-python3 Documentation',
     [author], 1)
]
