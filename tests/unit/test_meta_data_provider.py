...
class MetaDataProviderTest(unittest.TestCase):
    ...
    def test_server_meta_data_headers_full(self):
        ...
        shopping_cart_extension = ShoppingCartExtension("the Online Payments.creator", "Extension", "1.0",
                                                        "ExtensionId")
    ...
    def assertServerMetaInfo(self, meta_data_provider, integrator, shopping_cart_extension=None, request_header=None):
        ...
        server_meta_info = DefaultMarshaller.INSTANCE().unmarshal(server_meta_info_json,
                                                                  MetaDataProvider.ServerMetaInfo)
        ...
        if shopping_cart_extension is None:
            ...
            self.assertEqual(shopping_cart_extension.extension_id,
