...
from .i_hosted_fields_client import IHostedFieldsClient
...
class HostedFieldsClient(ApiResource, IHostedFieldsClient):
    """
    ...
    def __init__(self, parent: ApiResource, path_context: Optional[Mapping[str, str]]):
        ...
        """
        super(HostedFieldsClient, self).__init__(parent=parent, path_context=path_context)

    def create_hosted_fields_session(self, body: CreateHostedFieldsSessionRequest, context: Optional[CallContext] = None) -> CreateHostedFieldsSessionResponse:
        """
        Resource /v2/{merchantId}/hostedfields/sessions - Create hosted fields session

        :param body:     :class:`onlinepayments.sdk.domain.create_hosted_fields_session_request.CreateHostedFieldsSessionRequest`
        :param context:  :class:`onlinepayments.sdk.call_context.CallContext`
        :return: :class:`onlinepayments.sdk.domain.create_hosted_fields_session_response.CreateHostedFieldsSessionResponse`
        ...
        try:
            return self._communicator.post(
                    ...
                    None,
                    body,
                    CreateHostedFieldsSessionResponse,
                    context)
