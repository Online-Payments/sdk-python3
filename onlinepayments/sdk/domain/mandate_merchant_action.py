...
from onlinepayments.sdk.domain.mandate_redirect_data import MandateRedirectData
...
class MandateMerchantAction(DataObject):
    ...
    @property
    def redirect_data(self) -> MandateRedirectData:
        """
    ...
    def redirect_data(self, value: MandateRedirectData):
