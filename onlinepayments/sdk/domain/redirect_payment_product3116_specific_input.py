...
class RedirectPaymentProduct3116SpecificInput(DataObject):
    ...
    def to_dictionary(self) -> dict:
        dictionary = super(RedirectPaymentProduct3116SpecificInput, self).to_dictionary()
    ...
    def from_dictionary(self, dictionary: dict) -> 'RedirectPaymentProduct3116SpecificInput':
        super(RedirectPaymentProduct3116SpecificInput, self).from_dictionary(dictionary)
