...
from onlinepayments.sdk.domain.external_cardholder_authentication_data import ExternalCardholderAuthenticationData
...
class ThreeDSecure(DataObject):
    ...
    @property
    def external_cardholder_authentication_data(self) -> ExternalCardholderAuthenticationData:
        """
    ...
    def external_cardholder_authentication_data(self, value: ExternalCardholderAuthenticationData):
