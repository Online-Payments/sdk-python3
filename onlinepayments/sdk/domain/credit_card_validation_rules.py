...
class CreditCardValidationRules(DataObject):
    ...
    def to_dictionary(self) -> dict:
        dictionary = super(CreditCardValidationRules, self).to_dictionary()
    ...
    def from_dictionary(self, dictionary: dict) -> 'CreditCardValidationRules':
        super(CreditCardValidationRules, self).from_dictionary(dictionary)
