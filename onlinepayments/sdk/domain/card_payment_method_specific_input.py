...
from onlinepayments.sdk.domain.payment_product5002_specific_input import PaymentProduct5002SpecificInput
...
class CardPaymentMethodSpecificInput(DataObject):
    ...
    __payment_product5002_specific_input = None
    ...
    @property
    def payment_product5002_specific_input(self) -> PaymentProduct5002SpecificInput:
        """
    ...
    def payment_product5002_specific_input(self, value: PaymentProduct5002SpecificInput):
