...
class RedirectPaymentProduct3103SpecificInput(DataObject):
    ...
    def to_dictionary(self) -> dict:
        dictionary = super(RedirectPaymentProduct3103SpecificInput, self).to_dictionary()
    ...
    def from_dictionary(self, dictionary: dict) -> 'RedirectPaymentProduct3103SpecificInput':
        super(RedirectPaymentProduct3103SpecificInput, self).from_dictionary(dictionary)
