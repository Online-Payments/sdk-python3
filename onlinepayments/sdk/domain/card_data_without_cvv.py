...
class CardDataWithoutCvv(DataObject):
    ...
    def to_dictionary(self) -> dict:
        dictionary = super(CardDataWithoutCvv, self).to_dictionary()
    ...
    def from_dictionary(self, dictionary: dict) -> 'CardDataWithoutCvv':
        super(CardDataWithoutCvv, self).from_dictionary(dictionary)
