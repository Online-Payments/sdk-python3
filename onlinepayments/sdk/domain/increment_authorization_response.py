...
class IncrementAuthorizationResponse(DataObject):
    ...
    def to_dictionary(self) -> dict:
        dictionary = super(IncrementAuthorizationResponse, self).to_dictionary()
        if self.payment is not None:
            dictionary['payment'] = self.payment.to_dictionary()
        return dictionary

    def from_dictionary(self, dictionary: dict) -> 'IncrementAuthorizationResponse':
        super(IncrementAuthorizationResponse, self).from_dictionary(dictionary)
