...
class RedirectPaymentProduct5403SpecificInput(DataObject):
    ...
    def to_dictionary(self) -> dict:
        dictionary = super(RedirectPaymentProduct5403SpecificInput, self).to_dictionary()
    ...
    def from_dictionary(self, dictionary: dict) -> 'RedirectPaymentProduct5403SpecificInput':
        super(RedirectPaymentProduct5403SpecificInput, self).from_dictionary(dictionary)
