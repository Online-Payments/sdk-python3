...
class Product302Recurring(DataObject):
    ...
    def to_dictionary(self) -> dict:
        dictionary = super(Product302Recurring, self).to_dictionary()
    ...
    def from_dictionary(self, dictionary: dict) -> 'Product302Recurring':
        super(Product302Recurring, self).from_dictionary(dictionary)
