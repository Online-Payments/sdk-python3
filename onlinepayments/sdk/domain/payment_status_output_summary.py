...
class PaymentStatusOutputSummary(DataObject):
    ...
    def to_dictionary(self) -> dict:
        dictionary = super(PaymentStatusOutputSummary, self).to_dictionary()
    ...
    def from_dictionary(self, dictionary: dict) -> 'PaymentStatusOutputSummary':
        super(PaymentStatusOutputSummary, self).from_dictionary(dictionary)
