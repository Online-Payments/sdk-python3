...
class RedirectPaymentProduct5601SpecificInput(DataObject):
    ...
    def to_dictionary(self) -> dict:
        dictionary = super(RedirectPaymentProduct5601SpecificInput, self).to_dictionary()
    ...
    def from_dictionary(self, dictionary: dict) -> 'RedirectPaymentProduct5601SpecificInput':
        super(RedirectPaymentProduct5601SpecificInput, self).from_dictionary(dictionary)
